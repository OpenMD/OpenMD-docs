...
\section{The Statistics and Report Files}

An important output file generated by {\sc OpenMD} is the statistics
...
At the end of a simulation, {\sc OpenMD} will also produce a {\tt
  .report} file. This file contain statistics (means and 95\%
...
and \citealp{Shavalier:2023rm} for other approaches to computing
$G$. Users interested in {\it friction coefficients} at heterogeneous
interfaces may also find references
\citealp{2012MolPh.110..691K,Louden:2017tc}, and
\citealp{Louden:2018le} useful.
...
A recent test of OpenMD's parallel implementation found nearly linear
...
\caption[Performance of openmd\_MPI on parallel machinesl]{The
